# CAN 통신 - 통신 관련 전반적인 지식

Created by: Lee Hee Beom
Last edited: February 5, 2025 12:54 PM
Tags: CAN 통신

[1_강의교재_CAN통신_1전반지식_배포_워터마크.pdf](CAN%20%ED%86%B5%EC%8B%A0%20-%20%ED%86%B5%EC%8B%A0%20%EA%B4%80%EB%A0%A8%20%EC%A0%84%EB%B0%98%EC%A0%81%EC%9D%B8%20%EC%A7%80%EC%8B%9D/1_%EA%B0%95%EC%9D%98%EA%B5%90%EC%9E%AC_CAN%ED%86%B5%EC%8B%A0_1%EC%A0%84%EB%B0%98%EC%A7%80%EC%8B%9D_%EB%B0%B0%ED%8F%AC_%EC%9B%8C%ED%84%B0%EB%A7%88%ED%81%AC.pdf)

---

### 1. CAN(Controller Area Network) 통신 등장 배경 및 특징
...
- **등장 배경**
    ...
    ![image.png](CAN%20%ED%86%B5%EC%8B%A0%20-%20%ED%86%B5%EC%8B%A0%20%EA%B4%80%EB%A0%A8%20%EC%A0%84%EB%B0%98%EC%A0%81%EC%9D%B8%20%EC%A7%80%EC%8B%9D/image.png)
...
- **CAN 통신의 특징**
    - **버스형 토폴로지**
        ...
        - 전선의 무게가 감소하여 연비 향상
            ...
            ![image.png](CAN%20%ED%86%B5%EC%8B%A0%20-%20%ED%86%B5%EC%8B%A0%20%EA%B4%80%EB%A0%A8%20%EC%A0%84%EB%B0%98%EC%A0%81%EC%9D%B8%20%EC%A7%80%EC%8B%9D/image%201.png)
...
- **단점 및 해결 방안**
    - 특정 제어기의 고장으로 이상 신호를 보내면 버스를 통해 네트워크 전체에 영향을 미칠 수 있음 → CAN 프로토콜은 고장을 감지하면 해당 제어기를 통신에서 제외(Bus Off 상태)하여 다른 제어기 간 통신을 유지

### 2. CAN 커넥터

- CAN 통신은 **두 가닥의 전선, 신호 (CAN HIGH, CAN LOW)** 사용
    
    ![image.png](CAN%20%ED%86%B5%EC%8B%A0%20-%20%ED%86%B5%EC%8B%A0%20%EA%B4%80%EB%A0%A8%20%EC%A0%84%EB%B0%98%EC%A0%81%EC%9D%B8%20%EC%A7%80%EC%8B%9D/image%202.png)
...
- 전기 신호를 주고받기 위해 **D-Sub 커넥터**를 사용하여 제어기와 버스 통일 및 연결
    ...
    - 제어기와 버스에 같은 D-Sub 커넥터를 사용하고, 핀 번호를 통일하면 손쉽게 연결 가능
        ...
        ![image.png](CAN%20%ED%86%B5%EC%8B%A0%20-%20%ED%86%B5%EC%8B%A0%20%EA%B4%80%EB%A0%A8%20%EC%A0%84%EB%B0%98%EC%A0%81%EC%9D%B8%20%EC%A7%80%EC%8B%9D/image%203.png)
...
![image.png](CAN%20%ED%86%B5%EC%8B%A0%20-%20%ED%86%B5%EC%8B%A0%20%EA%B4%80%EB%A0%A8%20%EC%A0%84%EB%B0%98%EC%A0%81%EC%9D%B8%20%EC%A7%80%EC%8B%9D/image%204.png)

- 통신 문제가 발생할 때는, 사용 중인 커넥터에 **120옴 저항 여부를 확인** 필요

### 4. CAN High & Low Signal
...
- 데이터 **0 (Dominant)**는 데이터 **1 (Recessive)**보다 우선순위가 높음
    ...
    - 1번 제어기 → 데이터 0 출력, 2~4번 제어기 → 데이터 1 출력 → 버스 전체는 데이터 0 출력
        ...
        ![image.png](CAN%20%ED%86%B5%EC%8B%A0%20-%20%ED%86%B5%EC%8B%A0%20%EA%B4%80%EB%A0%A8%20%EC%A0%84%EB%B0%98%EC%A0%81%EC%9D%B8%20%EC%A7%80%EC%8B%9D/image%205.png)
...
### 4. CAN Tranceiver(Transmitter+Receiver) & CAN Controller
